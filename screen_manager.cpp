...
static void add_clock_format_setting(lv_obj_t* parent) {
  ...
  // Make the switch clearly visible on dark backgrounds
  lv_obj_set_style_bg_color(g_clockSwitch, lv_color_hex(0x333333), 0);
  lv_obj_set_style_bg_opa(g_clockSwitch, LV_OPA_COVER, 0);
  lv_obj_set_style_outline_width(g_clockSwitch, 1, 0);
  lv_obj_set_style_outline_color(g_clockSwitch, lv_color_hex(0x555555), 0);
}
...
static void add_currency_setting(lv_obj_t* parent) {
  ...
  // Dropdown (options order matches currency_index_from_iso)
  ...
  // Make dropdown readable on dark backgrounds
  lv_obj_set_style_text_color(g_currencyDrop, lv_color_hex(0xFFFFFF), 0);
  lv_obj_set_style_text_opa(g_currencyDrop, LV_OPA_COVER, 0);
  lv_obj_set_style_bg_color(g_currencyDrop, lv_color_hex(0x111111), 0);
  lv_obj_set_style_bg_opa(g_currencyDrop, LV_OPA_COVER, 0);
  lv_obj_set_width(g_currencyDrop, 180);
}
...
lv_obj_t* create_settings_screen() {
  ...
  lv_obj_t* settingsLabel = lv_label_create(scr);
  lv_label_set_text(settingsLabel, "SETTINGS");
  lv_obj_set_style_text_color(settingsLabel, lv_color_hex(0xFCA420), 0);
  lv_obj_set_style_text_font(settingsLabel, &lv_font_montserrat_20, 0);
  lv_obj_align(settingsLabel, LV_ALIGN_TOP_RIGHT, -25, 10);
  ...
  lv_obj_set_style_pad_bottom(prefsTitle, 6, 0);
