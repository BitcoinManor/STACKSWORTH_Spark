// BLOKDBIT_Spark bigstats_screen.cpp
// SPARKv0.03
...
lv_obj_t* create_bigstats_screen() {
  ...
  lv_label_set_text(priceheightLabel, "Price and Height");
  lv_obj_set_style_text_color(priceheightLabel, lv_color_hex(0xFFFFFF), 0);
  lv_obj_set_style_text_font(priceheightLabel, &lv_font_montserrat_14, 0);
  lv_obj_align(priceheightLabel, LV_ALIGN_TOP_RIGHT, -20, 60);
